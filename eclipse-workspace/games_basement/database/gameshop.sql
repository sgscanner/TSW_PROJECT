...
insert into Articolo (codice_articoli, codice_catalogo, descrizione, prezzo, nome, tipologia_articoli, offerta, quantita) values
    ...
    ('146','2','La Xbox 360 è una console per videogiochi prodotta da Microsoft con la collaborazione di IBM, ATI Technologies e Samsung ed è succeduta alla prima Xbox.','230.00','Xbox360','console',false,'10'),
    ('147','2','La Xbox One è una console per videogiochi prodotta da Microsoft. La macchina dispone di varie funzioni multimediali oltre a quelle di intrattenimento videoludico e fa parte dell ottava generazione di console, ','300.00','XboxOne','console',false,'10'),
    ('148','2','La Xbox Serie S è una console per videogiochi prodotta da Microsoft.La console fa parte della quarta generazione della famiglia Xbox','350.00','XboxSerieS','console',false,'10'),
    ('149','2','La Xbox Serie X è una console per videogiochi prodotta da Microsoft.La console fa parte della quarta generazione della famiglia Xbox','500.00','XboxSerieX','console',true,'5'),
